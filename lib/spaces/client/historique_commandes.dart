...
class _HistoriqueCommandesPageState extends State<HistoriqueCommandesPage> {
  ...
  static const _statuses = ['ALL', 'PENDING', 'IN_TRANSIT', 'DELIVERED', 'FAILED', 'CANCELLED'];
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () => showOrderDetailSheet(context, filtered[index]),
  ...
  Widget _buildHistoryCard(OrderDTO order) {
    ...
    final dateStr = _formatDate(order.actualDeliveryTime ?? order.estimatedDeliveryTime);
      ...
      child: Row(
        children: [
                ...
                if (dateStr.isNotEmpty) ...[
                  ...
                  Row(
                    children: [
                      ...
                      Text(dateStr, style: TextStyle(fontSize: 11, color: Colors.grey.shade500, fontWeight: FontWeight.w500)),
                    ],
                  ),
                ],
              ],
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isDelivered ? const Color(0xFFE8F5E9) : isFailed ? const Color(0xFFFFEBEE) : const Color(0xFFF0F1F5),
              borderRadius: BorderRadius.circular(8),
            ),
            child: Text(
              _statusLabel(order.status),
              style: TextStyle(
                color: isDelivered ? const Color(0xFF2E7D32) : isFailed ? const Color(0xFFC62828) : Colors.black54,
                fontSize: 11,
