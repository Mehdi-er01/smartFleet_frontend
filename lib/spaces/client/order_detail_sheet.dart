...
class _OrderDetailSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isInProgress = order.status == 'IN_PROGRESS' || order.status == 'IN_TRANSIT';
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              const Text(
                                'Order Details',
                                style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Colors.black54, letterSpacing: 0.8),
                              ),
                    ...
                    _infoRow(Icons.location_on_rounded, 'Delivery Address', order.deliveryAddress),
                    if (order.deliveryDescription != null && order.deliveryDescription!.isNotEmpty)
                      _infoRow(Icons.notes_rounded, 'Description', order.deliveryDescription!),
                    ...
                    Row(
                      children: [
                        Expanded(child: _metricCard(Icons.scale_rounded, '${order.weightKg} kg', 'Weight')),
                        const SizedBox(width: 12),
                        Expanded(child: _metricCard(Icons.view_in_ar_rounded, '${order.volumeM2} m³', 'Volume')),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.my_location_rounded, color: Colors.blue.shade600, size: 20),
                          const SizedBox(width: 12),
                          Text(
  ...
  Widget _sectionTitle(String text) {
    return Text(
      text.toUpperCase(),
      style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 1.5, color: Colors.black45),
    );
  }
  ...
  Widget _timelineRow(IconData icon, String label, String value,
      {bool isFirst = false, bool isLast = false, Color color = Colors.black54}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Column(
